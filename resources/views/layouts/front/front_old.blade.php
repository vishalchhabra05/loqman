...
<html>
    <head>
        ...
        ?>
        <title>
        <?php if($title_page == 'JobProviders'){
        echo $site_title.' - Gig Providers';
      }elseif($title_page == 'JobSeekers') {
        echo $site_title.' - Gig Seekers';
      } else {
          echo $page_title;
      }?>
       </title>
        ...
        <link rel="stylesheet" href="{{asset('assets/admin/_all-skins.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/admin/sweetalert.css')}}">  
        <link rel="stylesheet" href="{{asset('assets/admin/bootstrap-material-datetimepicker.css')}}">  
...
$.widget.bridge('uibutton', $.ui.button);
        ...
        <script src="{{asset('assets/admin/bootstrap-material-datetimepicker.min.js')}}"></script>
        <?php
